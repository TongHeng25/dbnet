...
def init_args():
    ...
    parser.add_argument('--model_path', default=r'D:/AI/DBNet/output62/model_best.pth', type=str)
    parser.add_argument('--input_folder', default='D:/AI/DBNet/datasets/icpr_mtwi_task2/img/', type=str, help='img path for predict')
